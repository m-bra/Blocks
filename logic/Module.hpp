...
inline void Module<Shared>::generate(ivec3_c &c)
{
	...
	Log::debug("logics::generate: getting blockLock");
	shared->blockWriteLock.lock(c);
	Log::debug("logics::generate: got blockLock.");

	Log::debug("logics::generate: getting moveLock...");
	shared->moveLock.lock();
	Log::debug("logics::generate: got moveLock.");
	...
	Log::debug("logics::generate: unlocking moveLock...");
	shared->moveLock.unlock();
	Log::debug("logics::generate: moveLock unlocked.");

	Log::debug("logics::generate: unlocking blockLock ...");
	shared->blockWriteLock.unlock(c);
	Log::debug("logics::generate: blockLock unlocked.");
